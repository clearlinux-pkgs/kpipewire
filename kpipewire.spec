...
Version  : 6.1.5
Release  : 48
URL      : https://download.kde.org/stable/plasma/6.1.5/kpipewire-6.1.5.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.1.5/kpipewire-6.1.5.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.5/kpipewire-6.1.5.tar.xz.sig
...
%setup -q -n kpipewire-6.1.5
cd %{_builddir}/kpipewire-6.1.5
pushd ..
cp -a kpipewire-6.1.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1725987752
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPipeWire.so.6.1.5
/V3/usr/lib64/libKPipeWireDmaBuf.so.6.1.5
/V3/usr/lib64/libKPipeWireRecord.so.6.1.5
...
/usr/lib64/libKPipeWire.so.6.1.5
/usr/lib64/libKPipeWireDmaBuf.so.6
/usr/lib64/libKPipeWireDmaBuf.so.6.1.5
/usr/lib64/libKPipeWireRecord.so.6
/usr/lib64/libKPipeWireRecord.so.6.1.5
