...
Source0  : https://download.kde.org/stable/plasma/5.27.9/kpipewire-5.27.9.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.9/kpipewire-5.27.9.tar.xz.sig
...
%prep
%setup -q -n kpipewire-5.27.9
cd %{_builddir}/kpipewire-5.27.9
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698280808
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKPipeWire.so.5.27.9
/usr/lib64/libKPipeWireDmaBuf.so.5
/usr/lib64/libKPipeWireDmaBuf.so.5.27.9
/usr/lib64/libKPipeWireRecord.so.5
/usr/lib64/libKPipeWireRecord.so.5.27.9
