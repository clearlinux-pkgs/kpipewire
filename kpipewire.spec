...
%setup -q -n kpipewire-6.1.1
cd %{_builddir}/kpipewire-6.1.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719417510
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPipeWire.so.6.1.1
/V3/usr/lib64/libKPipeWireDmaBuf.so.6.1.1
/V3/usr/lib64/libKPipeWireRecord.so.6.1.1
...
/usr/lib64/libKPipeWire.so.6.1.1
/usr/lib64/libKPipeWireDmaBuf.so.6
/usr/lib64/libKPipeWireDmaBuf.so.6.1.1
/usr/lib64/libKPipeWireRecord.so.6
/usr/lib64/libKPipeWireRecord.so.6.1.1
