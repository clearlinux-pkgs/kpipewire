...
Version  : 6.0.4
Release  : 32
URL      : https://download.kde.org/stable/plasma/6.0.4/kpipewire-6.0.4.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.0.4/kpipewire-6.0.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.0.4/kpipewire-6.0.4.tar.xz.sig
...
%setup -q -n kpipewire-6.0.4
cd %{_builddir}/kpipewire-6.0.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713289619
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPipeWire.so.6.0.4
/V3/usr/lib64/libKPipeWireDmaBuf.so.6.0.4
/V3/usr/lib64/libKPipeWireRecord.so.6.0.4
...
/usr/lib64/libKPipeWire.so.6.0.4
/usr/lib64/libKPipeWireDmaBuf.so.6
/usr/lib64/libKPipeWireDmaBuf.so.6.0.4
/usr/lib64/libKPipeWireRecord.so.6
/usr/lib64/libKPipeWireRecord.so.6.0.4
