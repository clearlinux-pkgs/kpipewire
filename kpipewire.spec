...
Source0  : https://download.kde.org/stable/plasma/6.3.1/kpipewire-6.3.1.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.1/kpipewire-6.3.1.tar.xz.sig
...
%setup -q -n kpipewire-6.3.1
cd %{_builddir}/kpipewire-6.3.1
pushd ..
cp -a kpipewire-6.3.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739900173
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPipeWire.so.6.3.1
/V3/usr/lib64/libKPipeWireDmaBuf.so.6.3.1
/V3/usr/lib64/libKPipeWireRecord.so.6.3.1
...
/usr/lib64/libKPipeWire.so.6.3.1
/usr/lib64/libKPipeWireDmaBuf.so.6
/usr/lib64/libKPipeWireDmaBuf.so.6.3.1
/usr/lib64/libKPipeWireRecord.so.6
/usr/lib64/libKPipeWireRecord.so.6.3.1
