...
%prep
%setup -q -n kpipewire-5.27.10
cd %{_builddir}/kpipewire-5.27.10
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707082224
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPipeWire.so.5.27.10
/V3/usr/lib64/libKPipeWireDmaBuf.so.5.27.10
/V3/usr/lib64/libKPipeWireRecord.so.5.27.10
/V3/usr/lib64/qt5/qml/org/kde/pipewire/libKPipeWireDeclarative.so
/V3/usr/lib64/qt5/qml/org/kde/pipewire/record/libKPipeWireRecordDeclarative.so
/usr/lib64/libKPipeWire.so.5
/usr/lib64/libKPipeWire.so.5.27.10
/usr/lib64/libKPipeWireDmaBuf.so.5
/usr/lib64/libKPipeWireDmaBuf.so.5.27.10
/usr/lib64/libKPipeWireRecord.so.5
/usr/lib64/libKPipeWireRecord.so.5.27.10
