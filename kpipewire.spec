...
Source0  : https://download.kde.org/stable/plasma/6.3.3/kpipewire-6.3.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.3/kpipewire-6.3.3.tar.xz.sig
...
%setup -q -n kpipewire-6.3.3
cd %{_builddir}/kpipewire-6.3.3
pushd ..
cp -a kpipewire-6.3.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742458574
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPipeWire.so.6.3.3
/V3/usr/lib64/libKPipeWireDmaBuf.so.6.3.3
/V3/usr/lib64/libKPipeWireRecord.so.6.3.3
...
/usr/lib64/libKPipeWire.so.6.3.3
/usr/lib64/libKPipeWireDmaBuf.so.6
/usr/lib64/libKPipeWireDmaBuf.so.6.3.3
/usr/lib64/libKPipeWireRecord.so.6
/usr/lib64/libKPipeWireRecord.so.6.3.3
