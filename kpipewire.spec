...
Version  : 6.3.0
Release  : 58
URL      : https://download.kde.org/stable/plasma/6.3.0/kpipewire-6.3.0.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.3.0/kpipewire-6.3.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.0/kpipewire-6.3.0.tar.xz.sig
...
%setup -q -n kpipewire-6.3.0
cd %{_builddir}/kpipewire-6.3.0
pushd ..
cp -a kpipewire-6.3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739292691
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPipeWire.so.6.3.0
/V3/usr/lib64/libKPipeWireDmaBuf.so.6.3.0
/V3/usr/lib64/libKPipeWireRecord.so.6.3.0
...
/usr/lib64/libKPipeWire.so.6.3.0
/usr/lib64/libKPipeWireDmaBuf.so.6
/usr/lib64/libKPipeWireDmaBuf.so.6.3.0
/usr/lib64/libKPipeWireRecord.so.6
/usr/lib64/libKPipeWireRecord.so.6.3.0
